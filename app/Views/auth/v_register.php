                    ...
                    <form action="<?= base_url() ?>/register" method="post">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="nama_lengkap" class="form-control" placeholder="Masukan Nama Lengkap" value="<?= old('nama_lengkap') ?>">
                            </div>
                            <div class="row">
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <input type="password" name="cpassword" class="form-control" placeholder="Masukan password">
                                </div>
                            </div>
                            <p class="mb-0">Sudah punya akun? <a href="<?= base_url() ?>/admin/login">Login</a></p>
                        </div>
